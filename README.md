...
Review the resulting PKGBUILD changes before committing them. The nightly `update.yml` workflow runs the same update, commits each changed package to `main`, and triggers the publish workflow.
